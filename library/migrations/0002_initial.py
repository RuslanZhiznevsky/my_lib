...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(help_text='user, to whom add category', on_delete=django.db.models.deletion.CASCADE, related_name='book_categories', related_query_name='book_category', to=settings.AUTH_USER_MODEL, verbose_name='user'),
        ),
        migrations.AddField(
            model_name='book',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.bookcategory', verbose_name='category'),
        ),
        migrations.AddField(
            model_name='book',
            name='user',
